        ...
        <div class="barra-bg">
            <div class="barra contenedor-nav">
                ...
                <nav class="barra__nav">
                    <a href="index.html">Mi reserva
                            <div class="barra__before"></div>
                    </a>
                    <a href="servicio.html">Destinos
                        <div class="barra__before"></div>
                    </a>
                    <a href="aerolineas.html">Aerolineas Plus
                        <div class="barra__before"></div>
                    </a>
                    <a href="mi-reserva.html">Informacion
                        <div class="barra__before"></div>
                    </a>
                </nav>
                <div class="barra__div">
                    <a href="sesion.html" name="iniciar">Iniciar Sesion
                        <div class="barra__before"></div>
                    </a>
                </div>
            </div>
